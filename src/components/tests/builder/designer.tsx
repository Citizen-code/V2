...
export default function Designer({types}:{types:type_question[]}) {
  ...
  return (
    <div className="grid grid-cols-4 w-full h-full min-h-full">
      <div className='p-4 col-span-3 w-full overflow-y-auto' onClick={() => { if (selectedElement) setSelectedElement(null) }}>
...
function DesignerElementWrapper({ element }: { element: test_questions }) {
